...
def scrape_product_listings(url):
    ...
    for product in products:
        ...
        if product_link:
            ...
            rating_icon_element = product.find("span", class_="a-icon")
            rating_element = rating_icon_element.find_next("span", class_="a-icon-alt") if rating_icon_element else None
...
def scrape_product_details(product_url, product_name, product_price, rating, num_reviews):
    ...
    asin_element = soup.find("th", class_="a-color-secondary a-size-base prodDetSectionEntry", text="ASIN")
    asin = asin_element.find_next_sibling("td", class_="a-size-base prodDetAttrValue").text.strip() if asin_element else "Not available"
    ...
    manufacturer_element = soup.find("th", class_="a-color-secondary a-size-base prodDetSectionEntry", text="Brand")
    manufacturer = manufacturer_element.find_next_sibling("td", class_="a-size-base prodDetAttrValue").text.strip() if manufacturer_element else "Not available"
